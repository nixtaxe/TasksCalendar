...
public class AddEditEventActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EVENT_NAME = "zabortceva.taskscalendar.EXTRA_EVENT_NAME";
    public static final String EXTRA_EVENT_DETAILS = "zabortceva.taskscalendar.EXTRA_EVENT_DETAILS";
    public static final String EXTRA_EVENT_LOCATION = "zabortceva.taskscalendar.EXTRA_EVENT_LOCATION";
    public static final String EXTRA_EVENT_STATUS = "zabortceva.taskscalendar.EXTRA_EVENT_STATUS";
